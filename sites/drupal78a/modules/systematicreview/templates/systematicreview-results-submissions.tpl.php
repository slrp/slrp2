 ...
 * - $total_count: The total number of submissions to this systematic review.
...
<?php if (count($table['#rows'])): ?>
  <?php print theme('systematicreview_results_per_page', array('total_count' => $total_count, 'pager_count' => $pager_count)); ?>
...
<?php if ($is_submissions): ?>
  <?php print theme('links', array('links' => array('systematicreview' => array('title' => t('Go back to the form'), 'href' => 'node/' . $node->nid)))); ?>
<?php endif; ?>
